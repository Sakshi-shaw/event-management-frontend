...
function MoreRejectedtedEvents() {
  ...
  useEffect(() => {
    const getRejectedEvents = async () => {
      try {
        const response = await Global.getRejectedEvents(Global.userId);
    ...
    <div className="flex overflow-hidden flex-col items-center pt-12 bg-gray-50 rounded-3xl">
      ...
      <div className="flex flex-col items-center mt-8 w-full">
        ...
        <div className="text-4xl font-bold text-violet-600 mt-8 text-center">
          All Rejected <span className="text-violet-600">Events</span>
        </div>
...
export default MoreRejectedtedEvents;
